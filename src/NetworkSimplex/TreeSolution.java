...
public class TreeSolution {
	...
	// the onstructor will only be used once in the Reader class to construct an
	// intial feasable tree solution
	...
	public boolean iterate() {
		...
		System.out.println(this.graphvizStringArcs(enteringArc));

		ArrayList<Integer> pathUV = findPathBetweenUV(
				enteringArc.getStartNodeIndex(), enteringArc.getEndNodeIndex());
		return false;
	}
